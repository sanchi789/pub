...
def call(String jenkinsSecret, String repoLink, String branchName,String helmRepoLink, String valuesFilePath,String dockerFilePath = 'docker/Dockerfile',String dockerRepoUrl,String awsRegion,String appName){
  ...
  stage('Docker ECR Push') {
   steps{
    ...
    stage('kuber deploy through argod'){
      steps {
       script{
       utilities.kuberneterDeployArgo("${helmRepoLink}","${valuesFilePath}","${jenkinsSecret}","${branchName}")
      }
      }
    }
}
